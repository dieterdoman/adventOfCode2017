...
sumDifference :: [Int] -> Int
sumDifference = sum

checkSum :: String -> Int
checkSum = sumDifference.getDifferenceList.getMinMaxPairList.convertToInteger.splitRowElements.constructRow
...
test :: String
test = "104 240 147 246 123 175 372 71 116 230 260 118 202 270 277 292\n\
